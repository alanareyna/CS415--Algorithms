    ...
    def StandardTrieAutocompleteHelperFunction(self, PointerToNode, ListOfSuffixes, WordToBuild):
        ...
        for iteration in range(0, 26):
            ...
            if PointerToNode.OurCharacterArray[iteration] != None:
                ...
                self.StandardTrieAutocompleteHelperFunction(PointerToNode.OurCharacterArray[iteration], ListOfSuffixes,
                                                            WordToBuild + chr((iteration + ord('a'))))
...
def main():
    ...
    if sys.argv[2] == "1":
        ...
        print("Time taken to build the standard "
              "Trie is " + str(
            TimeTakenToBuildStandardTrie) + " and space occupied by it is " + str(NumberOfCharactersCounter))
        ...
        print("Time taken to build the BST based Trie is " + str(
            time_taken_to_build_tst) + " and space occupied by it is " + str(tst_size))
        ...
        print("Time taken to find auto-complete results in the standard Trie is " + str(
            TimeTakenToAutocompleteInStandardTrie))
        ...
        print(
            "Time taken to find auto-complete results in the BST based Trie is " + str(time_taken_to_autocomplete_tst))
    ...
    if sys.argv[2] == "2":
        ...
        print("Time taken to build the standard Trie is " + str(
            TimeTakenToBuildStandardTrie) + " and space occupied by it is " + str(NumberOfCharactersCounter))
        ...
        print("Time taken to search all the strings in the standard Trie is " + str(
            TimeTakenToSearchAllStringsInStandardTrie))
